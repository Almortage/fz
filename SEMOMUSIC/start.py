...
from SEMOMUSIC.info import (is_served_chat, add_served_chat, is_served_user, add_served_user, get_served_chats, get_served_users, del_served_chat, joinch)
from SEMOMUSIC.Data import (get_dev, get_bot_name, set_bot_name, get_logger, get_group, get_channel, get_dev_name, get_groupsr, get_channelsr, get_userbot, get_video_source, set_dev_user, get_dev_user, set_video_source)
...
from pyrogram.enums import ChatType, ChatMemberStatus, ParSEMOMUSICde, ChatMemberStatus
import os
import re
import textwrap
import aiofiles
...
async def videoo(client, message):
  ...
  if len(listvid) == 0:
   user = await get_userbot(client.me.username)
   async for msg in user.get_chat_history("videi_SEMOMUSIC"):
      if msg.video:
        listvid.append(msg.id)
  id = random.choice(listvid)
  video = f"https://t.me/videi_SEMOMUSIC/{id}"
